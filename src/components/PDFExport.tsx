...
<div class="stat"><div class="stat-label">Years to FIRE</div><div class="stat-value ${comparison.earlierRetirement === country1Code ? 'highlight' : ''}">${result1.yearsToFIRE} years</div></div>
...
<div class="stat"><div class="stat-label">After Tax Withdrawal</div><div class="stat-value">${formatCurrency(result1.netAnnualIncome, country1?.currency || 'USD')}</div></div>
</div>
...
<div class="stat"><div class="stat-label">Years to FIRE</div><div class="stat-value ${comparison.earlierRetirement === country2Code ? 'highlight' : ''}">${result2.yearsToFIRE} years</div></div>
...
<div class="stat"><div class="stat-label">After Tax Withdrawal</div><div class="stat-value">${formatCurrency(result2.netAnnualIncome, country2?.currency || 'USD')}</div></div>
</div></div>
...
${comparison.earlierRetirement ? `<li>• You can retire <strong>${Math.abs(result1.yearsToFIRE - result2.yearsToFIRE)} years</strong> sooner in <strong>${countries[comparison.earlierRetirement]?.name}</strong></li>` : ''}
</ul></div></div>
